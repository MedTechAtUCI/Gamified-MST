...
import OmstTitlePage from '@/app/components/TitlePage/OmstTitlePage';
import OMSTTaskPage from '@/app/components/TaskPage/OMSTTaskPage';
...
const ACTIVE_ROUTE = 'omst';

function OMSTContent() {
  ...
  if (!hasConsented) {
    return <OmstTitlePage route={ACTIVE_ROUTE} />;
  }
